...
const TERMS: Clause[] = [
  ...
  },
  {
     ...
     */
    title: "제5조 (책임의 제한)",
    body: "무료 서비스이며, 추천을 믿고 생긴 손해는 책임지지 않습니다.",
  },
];
...
const PRIVACY: Clause[] = [
  ...
  {
    /*
     * 탈퇴 경로가 생겼다(2026-09-15, DELETE /api/account). 계정·대화·일정·취향·
     * 즐겨찾기를 함께 지운다.
     *
     * **남기기로 한 것이 하나 있어서 예외를 함께 적는다.** 보내 주신 피드백은
     * 지우지 않는다(협의) — response_feedback은 세션 정리에서도 제외돼 있는 분석
     * 데이터인데, user_input·assistant_message에 발화가 담긴다. 적지 않으면
     * "탈퇴하면 지웁니다"가 거짓이 된다.
     */
    title: "제3조 (보유 및 이용 기간)",
    body: "회원 탈퇴 시까지 — 보내주신 피드백은 남습니다",
  },
  {
    title: "제4조 (제3자 제공)",
    body: "제공하지 않음",
