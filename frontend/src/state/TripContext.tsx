 ...
 * 뒤에서부터 자른다. 왜 셋인지는 그쪽 주석에 있다(넓히면 모델이 규칙을 어긴다).
 */
 ...
 * 오래된 것부터 버린다.
 *
 * 상한이 세 개라 사실상 직전 턴의 버튼만 남는다. 더 멀리까지 막으려다 오히려 버튼을
 * 잃는다는 것이 실측 결과였다(backend/app/schemas.py의 MAX_RECENT_FOLLOW_UPS 주석).
 */
