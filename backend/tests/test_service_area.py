...
_OUTSIDE = {
    # 송파구·강동구 — 광진구가 들어오면서 새로 생긴 동남쪽 경계
    ...
    # 강남구 — 서초구가 들어오면서 새로 생긴 동쪽 경계(2026-08-28).
    # 강남역은 쓰지 않는다: 서초구·강남구 경계에 걸쳐 있어 흔히 쓰는 좌표
    # (37.4979, 127.0276)가 서초구 쪽이라 대조군 노릇을 못 한다.
    "삼성역": (37.5089, 127.0631),
    "선릉역": (37.5044, 127.0490),
    # 광명·과천·안양 — 구로구·금천구·관악구·서초구가 들어오면서 새로 생긴
    # 남서·남쪽 경계(서울 밖, 2026-08-28)
