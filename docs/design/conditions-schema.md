...
| `max_travel_time` | user_conditions | 선택 | 없으면 기본 1km, 있으면 MVP 도보 기준 `분 × 0.07km`를 후보 수집 반경으로 적용(최소 0.1km, 최대 20km) |
...
| v0.4 | 2026-07-27 | C 후보 수집 반경을 A 기준인 기본 1km 또는 `max_travel_time × 0.07km`로 정의하고 최소·최대 범위를 명시 |
