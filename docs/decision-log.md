...
### D-098 — INFO 장소 되묻기: 편집거리 매칭 + 후보 버튼 노출 + 상태 저장 이어받기
...
### D-099 — 공영주차장 실시간 현황을 일반 근처 주차장과 분리한다
